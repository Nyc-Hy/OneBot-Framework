...
e
    "}, new (){"a", "b", "c", "d", "e"}),
        ...
        public void LexerForNormalMixedMessage()
        {
          List<(List<SoraSegment>, List<object>)> testCasts = new()
            {
                (new (){"mute ", SegmentHelper.ToAt(114514), " 1d"}, new (){"mute", SegmentHelper.ToAt(114514), "1d"}),
                (new (){"mute", SegmentHelper.ToAt(114514), "1d"}, new (){"mute", SegmentHelper.ToAt(114514), "1d"}),
            };
        ...
        public void LexerForNormalQuotedMixedMessage()
        {
            ...
            {
                (
                    new() { "draw 喜报 \"恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。\"" }, 
                    new() { "draw", "喜报", new MessageBody { "恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。" }}
                ),
                (
                    new() { "draw 喜报 '恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。'" }, 
                    new() { "draw", "喜报", new MessageBody { "恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。" }}
                ...
                (
                    ...
                    {
                        "draw 喜报 \"恭喜 ",
                        SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。\"'  ",
                        SegmentHelper.ToAt(1919810), "  '"
                    },
                    new()
                    {
                        "draw", "喜报", new MessageBody { "恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。" },
                        new MessageBody { "  ", SegmentHelper.ToAt(1919810), "  " }
                    }
                ),
                (
                    new() { "draw 喜报 \"恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。\"", SegmentHelper.ToAt(1919810) }, 
                    new() { "draw", "喜报", new MessageBody { "恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。" }, SegmentHelper.ToAt(1919810)}
                ),
                (
                    new() { "draw 喜报 \"恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。\"", "test" }, 
                    new() { "draw", "喜报", new MessageBody { "恭喜 ", SegmentHelper.ToAt(114514), "获得群 Bug 最多奖。" }, "test"}
                ),
            };
